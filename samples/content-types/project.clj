(defproject content-types "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "content-types.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.3.2-SNAPSHOT"]]}}
  :main ^{:skip-aot true} content-types.server)
